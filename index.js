var http       = require('http')
  ...
  MedicalInfo.prototype = Object.create(AlexaSkill.prototype);
  MedicalInfo.prototype.constructor = MedicalInfo;

  MedicalInfo.prototype.eventHandlers.onSessionStarted = function(sessionStartedRequest, session){
    // What happens when the session starts? Optional
    console.log("onSessionStarted requestId: " + sessionStartedRequest.requestId
        + ", sessionId: " + session.sessionId);
  };

  MedicalInfo.prototype.eventHandlers.onLaunch = function(launchRequest, session, response){
  ...
  MedicalInfo.prototype.intentHandlers = {
